    ...
    return (
        <div id='section2'>
            <div className='section2--orange'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="36" viewBox="0 0 60 36" fill="none" className='orange--outline'>
                    <path d="M42.0046 1L58.9689 17.9643L42.1846 34.7486" stroke="#161616"/>
                ...
                <div className='section2'>
                    ...
                    <div className='section2--blocks'>
                        <div className='section2--blocks__block'>
                            ...
                            <p>Mint Genesis NFT, Heroes art concepts, Launch of the community program, work on Beta.</p>
                        </div>
                        <div className='section2--blocks__block'>
